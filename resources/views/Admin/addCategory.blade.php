                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="manage_stockd-body">
                                <div class="manage_stockd-title">
                                    <h3 class="text-center title-2">Upload Category</h3>
                                </div>
                                 <hr>
                        ...
                        @csrf
                            <div class="form-group">
                                <label for="category">Category name</label>
                                    <input type="text" onload="convertToSlug(this.value)"  onkeyup="convertToSlug(this.value)" id='category' name="category" value="" class="form-control" placeholder="Category Name" required>
                                </div>
                                <div class="form-group">
